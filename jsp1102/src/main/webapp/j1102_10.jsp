...
<html>
	...
	<%
		...
		out.println("프로젝트명 : "+request.getContextPath()+"<br>"); //중요!!
		out.println("get,post : "+request.getMethod()+"<br>");
		out.println("프로토콜 : "+request.getProtocol()+"<br>");
		out.println("url전체주소 : "+request.getRequestURL()+"<br>");
		out.println("uri주소 : "+request.getRequestURI()+"<br>"); //중요!!
		out.println("접속자ip : "+request.getRemoteAddr()+"<br>"); //중요!! //user ip
		//파일명을 출력하시오.
